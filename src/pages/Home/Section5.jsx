                                ...
                                <Carousel.Caption>
                                    <div className="d-flex align-items-center justify-content-between">
                                        <div className="brand_img">
                                            <img src={Brand1} alt="brand-1" className="img-fuild" />
                                        </div>
                                        <div className="brand_img">
                                            <img src={Brand2} alt="brand-2" className="img-fuild" />
                                        </div>
                                        <div className="brand_img">
                                            <img src={Brand3} alt="brand-3" className="img-fuild" />
                                        </div>
                                        <div className="brand_img">
                                            <img src={Brand4} alt="brand-4" className="img-fuild" />
                                        </div>
                                        <div className="brand_img">
                                            <img src={Brand5} alt="brand-5" className="img-fuild" />
                                        </div>
                                        <div className="brand_img">
                                            <img src={Brand6} alt="brand-6" className="img-fuild" />
                                        </div>
                                    </div>
                                </Carousel.Caption>
                            </Carousel.Item>
                            <Carousel.Item>
                                <Carousel.Caption>
                                    <div className="d-flex align-items-center justify-content-between">
                                        ...
                                        <div className="brand_img">
                                            <img src={Brand7} alt="brand-7" className="img-fuild" />
                                        </div>
                                        <div className="brand_img">
                                            <img src={Brand8} alt="brand-8" className="img-fuild" />
                                        </div>
                                    </div>
                                </Carousel.Caption>
                            </Carousel.Item>
