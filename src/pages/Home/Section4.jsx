...
import PromotionTmage from "../../assets/assets/promotion/pro.png"
...
function Section4() {
    return (
        <>
                ...
                <Container>
                    <Row className="align-items-center">
                        <Col lg={6} className="text-center mb-5 mb-lg-0">
                            <img src={PromotionTmage} alt="Promotion" className="img-fluid" />
                        </Col>
            ...
            {/* BG Parallex Scroll */}
            <section className=" bg_parallex_scroll"></section>
        </>
    )
}
